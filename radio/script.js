...
// Se activa cuando el usuario da "Play" (requerido por navegadores)
audio.addEventListener('play', () => {
    if (!audioCtx) {
        ...
        analyser.fftSize = 64; // Cantidad de barras (puedes subir a 128)
...
function draw() {
    ...
    for (let i = 0; i < bufferLength; i++) {
        ...
        // Color de las barras (un azul neón que combine con tu botón)
        canvasCtx.fillStyle = rgb(50, 100, 255);
        
        // Dibujamos las barras centradas verticalmente
